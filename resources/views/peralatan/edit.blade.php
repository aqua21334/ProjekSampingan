...
<div class="container mx-auto py-8">
    <div class="max-w-lg mx-auto bg-white border border-gray-200 rounded-lg shadow-lg p-6">
        <h2 class="text-xl font-bold mb-6 text-gray-900">Edit Peralatan</h2>
        <form method="POST" action="{{ route('peralatan.update', $peralatan->kode_bmn) }}">
            @csrf
            @method('PUT')
            <div class="mb-4">
                <label for="kode_bmn" class="block text-gray-700 font-semibold mb-2">Kode BMN</label>
                <input type="text" name="kode_bmn" id="kode_bmn" class="border rounded px-3 py-2 w-full" value="{{ old('kode_bmn', $peralatan->kode_bmn) }}" required>
                @error('kode_bmn')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_peralatan" id="nama_peralatan" class="border rounded px-3 py-2 w-full" value="{{ old('nama_peralatan', $peralatan->nama_peralatan) }}" required>
            ...
            <div class="mb-4">
                ...
                <input type="date" name="tanggal_kalibrasi" id="tanggal_kalibrasi" class="border rounded px-3 py-2 w-full" value="{{ old('tanggal_kalibrasi', $peralatan->tanggal_kalibrasi) }}">
