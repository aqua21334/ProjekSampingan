    ...
    <div class="form-container">
        ...
        <form action="/peralatan" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="kode_bmn" name="kode_bmn" placeholder="Masukkan kode BMN" required>
            </div>

            <div class="form-group">
                <label for="nama_peralatan">Nama Peralatan</label>
                <input type="text" id="nama_peralatan" name="nama_peralatan" placeholder="Masukkan nama peralatan" required>
            </div>
